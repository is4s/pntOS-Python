...
class StandardStateModelProvider(CommonStateModelProvider, Protocol):
    ...
    def new_processor(
        ...
        Args:
            processor_index (int): Since the StandardStateModelProvider can create
            ...
            engine (StandardFusionEngine | None): An optional parameter that may be provided to the new
        ...
        Returns:
            ...
            :class:`StandardMeasurementProcessor` or None when no measurement
    ...
    def new_block(
        ...
        Args:
            block_index (int): Since the StandardStateModelProvider can create
    ...
    def new_virtual_block(
        ...
        Args:
            virtual_block_index (int): Since the StandardStateModelProvider can
        ...
        Returns:
            VirtualStateBlock | None: The newly created :class:`VirtualStateBlock`or None when no
            virtual state block can be produced with the given \p virtual_block_index and
            \p config_group.
        """
        pass
...
class StateModelingPlugin(CommonPlugin, Protocol):
    ...
    def new_state_model_provider(
        ...
        Returns:
            ...
            :class:`FusionType` or None if \p type is not supported (#is_fusion_type_supported can
