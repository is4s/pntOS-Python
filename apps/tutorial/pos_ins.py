...
def main() -> None:
    ...
    plugins: list[CommonPlugin] = [
        TutorialLcmLogTransportPlugin('Cobra Tutorial LCM Log Transport Plugin'),
        ...
        TutorialPosOrchestrationPlugin('Cobra Tutorial Orchestration Plugin'),
    ]
