...
Cobra
    ...
    | [Cobra Apps](./first_app.md)                          | `pntos-cobra-apps/src/pntos/apps/`    | `pntos.cobra.apps`     | Each app loads a set of Cobra plugins, defines any config values, and starts a {term}`pntOS-Python` implementation with the given apps.                                                                                                                                |
