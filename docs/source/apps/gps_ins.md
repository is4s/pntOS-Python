...
| {py:obj}`TutorialGpsInsStateModelingPlugin <pntos.cobra.TutorialGpsInsStateModelingPlugin>` | Models the state of the filter with Pinson15 states by providing a {py:obj}`PinsonPositionMeasurementProcessor <pntos.cobra.internal.PinsonPositionMeasurementProcessor>` and a {py:obj}`Pinson15NedBlock <pntos.cobra.internal.Pinson15NedBlock>` to the fusion engine.                                                                                                                                                                                 | [](../plugins/state_modeling_plugin.md)  |
