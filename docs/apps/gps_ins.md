...
| {py:obj}`UiLogPlottingPlugin <pntos.cobra.UiLogPlottingPlugin>`                           | Plots the results of the pntOS {term}`PVA` solution against a truth PVA from an {term}`LCM` log file upon shutdown.                                                                                                                                                                                    | [](../plugins/ui_plugin.md) |
