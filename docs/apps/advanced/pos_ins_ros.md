...
See `pntos-cobra-apps/src/pntos/apps/advanced/pos_ins_ros.py` for an example of using Cobra with ROS. This
app is very similar to `pntos-cobra-apps/src/pntos/apps/tutorial/pos_ins.py`, but the
